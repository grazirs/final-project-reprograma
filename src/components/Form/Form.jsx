      ...
      <form className='form' onSubmit={handleSubmit(onSubmit)}>
        <div className='field'>
          ...
          <div className='field-column'>
            ...
            <div className='input-project'><input {...register("threadColor")} type='radio' value={true} /><label className='label-project'>Sim</label> </div>
            <div className='input-project'><input {...register("threadColor")} type='radio' value={false} /><label className='label-project'>Não</label> </div>
